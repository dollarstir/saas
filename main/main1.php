                    ...
                    <div class="container">
                        <div class="banner-text">
                            ...
                            <div class="banner-btn">
                                ...
                                <a href="main/https://youtu.be/kpanwiv9fsw" class="default-btn popup-youtube">Watch
                                    Video</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="quote-text">
                        ...
                        <p>Sides the rhetoric at together lane. Briefs its if when for fall the act been in heaven what
                            as of sister her into ago, much the everything how and during into facility with have with
                            covered.</p>
                        <div class="theme-btn">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                    <div class="blog-card">
                        <div class="blog-img">
                            <a href="main/blog-details.html"><img loading="lazy" src="main/assets/img/blog/2.png"
                                    alt="blog image"></a>
                        </div>
                        <div class="blog-text">
                            <h3>
                                <a href="main/blog-details.html">New Vehicles in the Fleet – See Our New Scania
                                    Trucks</a>
                            </h3>
                            <ul>
                                <li>
                ...
                <div class="col-lg-4 col-sm-6 offset-sm-3 offset-lg-0 wow fadeInUp" data-wow-duration="1s"
                    ...
                    <div class="blog-card">
                        <div class="blog-img">
                            <a href="main/blog-details.html"><img loading="lazy" src="main/assets/img/blog/3.png"
                                    alt="blog image"></a>
                        </div>
                        <div class="blog-text">
                            <h3>
                                <a href="main/blog-details.html">Our Driver Confirm Lorry Repaired as soon as
                                    Possible</a>
                            </h3>
                            <ul>
                                <li>
