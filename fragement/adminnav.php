...
$lo = $get[0]['logo'];
$logo = $lo == '' ? '<img src="main/backend/img/logo.png" alt="">' : '<img src="yolkassets/upload/'.$lo.'" alt="">';
...
<li>
    ...
    <img src="main/backend/img/menu-icon/1.svg" alt="">
    <span>Dashboard</span>
    </a>
...
<img src="main/backend/img/menu-icon/2.svg" alt="">
...
function adminslide()
{
    ...
    foreach ($s as $row) {
        echo '<tr>
        <!-- <th> <a href="main/backend/data_table.html#" class="question_content"> title here 1</a></th> -->
